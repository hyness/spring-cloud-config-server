...
A docker image of [Spring Cloud Config Server](https://cloud.spring.io/spring-cloud-static/spring-cloud-config/1.4.4.RELEASE/single/spring-cloud-config.html).
