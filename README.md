...
A docker image of [Spring Cloud Config Server](https://docs.spring.io/spring-cloud-config/docs/3.1.5/reference/html/).
...
### Supported tags
* `3.1.5-jre8`, `3.1-jre8`, `jre8`
* `3.1.5-jdk8`, `3.1-jdk8`, `jdk8`
* `3.1.5-jre11`, `3.1-jre11`, `jre11`, `3.1.5`, `3.1`, `latest`
* `3.1.5-jdk11`, `3.1-jdk11`, `jdk11`
* `3.1.5-jre17`, `3.1-jre17`, `jre17`
* `3.1.5-jdk17`, `3.1-jdk17`, `jdk17`
...
* *JRE builds are now available and the default for latest, 3.1, 3.1.5*
